...
package local_project.creation_of_stagetable_0_1;
...
/**
 * Job: creation_of_stagetable Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class creation_of_stagetable implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "creation_of_stagetable";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				creation_of_stagetable.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(creation_of_stagetable.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:PBSKVhiJ2WdcdHhdsQSQ14ofNQUFkbifzMQ+mTbw6A/2sQnWnb8=");
...
public void tDBRow_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBRow_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WmmkiCkKSfttdeqBmgCCKso08XuZXqAmF2extfqRythQUlfibtc=");
...
query_tDBRow_2 = "INSERT INTO stagetable \nSELECT \"Search_Query\" ,\n cast(\"Recipe_id\" as int),\ntitle ,\ncast(\"usedIngredientCount\""
+" as int) ,\ncast(\"missedIngredientCount\"  as int),\ncast(ingredients_id  as int) , \ningredients_name,\naisle,\n\"Miss"
+"edorUsed\",\namount,\nunit \nFROM rawtable\n;";
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		local_project.creation_of_dimensionaltables_0_1.creation_of_dimensionaltables childJob_tRunJob_1 = new local_project.creation_of_dimensionaltables_0_1.creation_of_dimensionaltables();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final creation_of_stagetable creation_of_stagetableClass = new creation_of_stagetable();

        int exitCode = creation_of_stagetableClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = creation_of_stagetable.class.getClassLoader().getResourceAsStream("local_project/creation_of_stagetable_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = creation_of_stagetable.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : creation_of_stagetable");
        }
...
/************************************************************************************************
 *     43660 characters generated by Talend Open Studio for Big Data 
