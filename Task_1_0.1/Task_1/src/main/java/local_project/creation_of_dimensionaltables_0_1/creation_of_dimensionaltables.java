...
package local_project.creation_of_dimensionaltables_0_1;
...
/**
 * Job: creation_of_dimensionaltables Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class creation_of_dimensionaltables implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "creation_of_dimensionaltables";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				creation_of_dimensionaltables.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(creation_of_dimensionaltables.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:d33pLBF0yGrFm5P/GygAOojU6ehM9ORtp3sPB3xnefzu8rLORBg=");
...
query_tDBRow_1 = "create table IF NOT EXISTS dim_receipe(\nRe_id  SERIAL PRIMARY KEY,\nreceipe_id int,\ntitle varchar(100)\n);";
...
public void tDBRow_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBRow_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SPjFXD1Y9McGQyTlGIg7S0BsXtLPF5NNyS8Uoehp1fQOeLp1bso=");
...
query_tDBRow_2 = "insert into dim_receipe(receipe_id,title)\nSELECT  distinct a.receipe_id,a.title\nFROM stagetable a\nLEFT JOIN dim_rece"
+"ipe b \nON a.receipe_id =  b.receipe_id\nWHERE ( b.receipe_id IS NUll);";
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_4 = false;
		    ...
		    java.lang.Class jdbcclazz_tDBRow_4 = java.lang.Class.forName(driverClass_tDBRow_4);
				...
				String url_tDBRow_4 = "jdbc:postgresql://"+""+":"+"5432"+"/"+"soluvv_1";
				
					String dbUser_tDBRow_4 = "postgres";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:fdJ3g37On/YcuOJThnYyg4TLPJR+LtolgQsCY1JDi/lg0yrM4yA=");
...
+"archar(100)\n--foreign key (s_key) REFERENCES dim_ingredient_generator(s_key)\n);\n\n\ncreate table if not exists dim_in"
+"gredient_generator\n(\n   s_key  serial,\n   ingredients_id int\n)\n;\n\n\ndrop table if exists temp_dim_ingredients;\n"
+"\n\ncreate table temp_dim_ingredients as \nSELECT distinct max(a.ingredients_id) as ingredients_id ,\nmax(a.ingredients_n"
+"ame) as ingredients_name,\n max(a.aisle) as aisle\nFROM stagetable a      \nGROUP BY a.ingredients_id, a.ingredients_nam"
+"e,a.aisle;\n\n\ninsert into dim_ingredient_generator(ingredients_id)\nselect a.ingredients_id \nfrom temp_dim_ingredient"
+"s a\nleft join dim_ingredient_generator b \non a.ingredients_id = b.ingredients_id\nwhere b.ingredients_id is null;";
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_3 = false;
		    ...
		    java.lang.Class jdbcclazz_tDBRow_3 = java.lang.Class.forName(driverClass_tDBRow_3);
				...
				String url_tDBRow_3 = "jdbc:postgresql://"+""+":"+"5432"+"/"+"soluvv_1";
				
					String dbUser_tDBRow_3 = "postgres";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7TMWa8za5cAr+P8mfBDpegxVaTWWIv3F23nJiiMYJM8/PW1PTwg=");
...
+"ng temp_dim_ingredients\nwhere dim_Ingredient.ingredients_id = temp_dim_ingredients.ingredients_id;\n\n\n\ninsert into  "
+"dim_ingredient\n(s_key,ingredients_id,ingredients_name,aisle )\nselect  distinct\n	 max(b.s_key)\n	, a.ingredients_id\n	"
+",max(a.ingredients_name)\n	,max(a.aisle)\nfrom  temp_dim_ingredients a  \nleft  join dim_ingredient_generator b   \non a"
+".ingredients_id=b.ingredients_id \nleft join dim_ingredient c\non a.ingredients_id= c.ingredients_id \ngroup by a.ingred"
+"ients_id;  ";
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_5 = false;
		    ...
		    java.lang.Class jdbcclazz_tDBRow_5 = java.lang.Class.forName(driverClass_tDBRow_5);
				...
				String url_tDBRow_5 = "jdbc:postgresql://"+""+":"+"5432"+"/"+"soluvv_1";
				
					String dbUser_tDBRow_5 = "postgres";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:pJJD7InX02itU9Pk+T4u0/fTl2uwsBJadzPIYIiK6MyMFKc312s=");
...
query_tDBRow_5 = "create table IF NOT EXISTS dim_unit(\nU_id SERIAL PRIMARY KEY,\nunit varchar(100) \n);";
...
public void tDBRow_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_6 = false;
			String driverClass_tDBRow_6 = "org.postgresql.Driver";
		    java.lang.Class jdbcclazz_tDBRow_6 = java.lang.Class.forName(driverClass_tDBRow_6);
		
				String url_tDBRow_6 = "jdbc:postgresql://"+""+":"+"5432"+"/"+"soluvv_1";
				
					String dbUser_tDBRow_6 = "postgres";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_6 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:dsZsDqcroOugnpss+4+FOPWYVKDzATKd5oYrOOedA6zFdMQfex8=");
...
query_tDBRow_6 = "insert into dim_unit(unit)\n-- explain\nSELECT distinct\n(CASE \n WHEN (a.unit IS NULL OR a.unit = '' or a.unit='Empty'"
+") THEN 'Empty' ELSE a.unit END)\n from stagetable a\nLEFT JOIN dim_unit b \nON a.unit =  b.unit\nWHERE ( b.unit IS NUll "
+" and a.unit!='');";
...
public void tDBRow_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_7 = false;
			String driverClass_tDBRow_7 = "org.postgresql.Driver";
		    java.lang.Class jdbcclazz_tDBRow_7 = java.lang.Class.forName(driverClass_tDBRow_7);
		
				String url_tDBRow_7 = "jdbc:postgresql://"+""+":"+"5432"+"/"+"soluvv_1";
				
					String dbUser_tDBRow_7 = "postgres";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_7 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+6IZ45Oo2Tu5oBWG9fOse7DOf7H1zoiRB8LJDVgxXrbgUJj/LTA=");
...
query_tDBRow_7 = "create table if not exists dim_search_query( \nsid serial primary key,\nSearch_Query varchar(100)\n);";
...
public void tDBRow_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_8 = false;
			String driverClass_tDBRow_8 = "org.postgresql.Driver";
		    java.lang.Class jdbcclazz_tDBRow_8 = java.lang.Class.forName(driverClass_tDBRow_8);
		
				String url_tDBRow_8 = "jdbc:postgresql://"+""+":"+"5432"+"/"+"soluvv_1";
				
					String dbUser_tDBRow_8 = "postgres";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_8 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9squIw57wI5LGYIOvHevW0Mj4EFmmNwXRPStRoaAl4xS4jAMNDE=");
...
query_tDBRow_8 = "insert into dim_search_query(Search_Query)\nSELECT DISTINCT a.Search_Query\nFROM stagetable a\nLEFT JOIN dim_search_que"
+"ry b \nON a.Search_Query =  b.Search_Query\nWHERE ( b.Search_Query IS NUll);\n";
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		local_project.fact_table__0_1.fact_table_ childJob_tRunJob_1 = new local_project.fact_table__0_1.fact_table_();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final creation_of_dimensionaltables creation_of_dimensionaltablesClass = new creation_of_dimensionaltables();

        int exitCode = creation_of_dimensionaltablesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = creation_of_dimensionaltables.class.getClassLoader().getResourceAsStream("local_project/creation_of_dimensionaltables_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = creation_of_dimensionaltables.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : creation_of_dimensionaltables");
        }
...
/************************************************************************************************
 *     85414 characters generated by Talend Open Studio for Big Data 
